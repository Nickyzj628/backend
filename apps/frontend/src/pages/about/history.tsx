...
const History = () => {
	const history = [
		...
		},
		{
			...
			description:
				"经过一年的沉淀，在学习Vue、React、Svelte等前端框架后，最后一版个人网站诞生！",
		...
		},
		{
			...
			description:
				"意识到Typecho作为内容管理系统难以实现网页应用，于是在延续设计风格的同时更换了CakePHP框架。",
		...
		},
		{
			...
			description:
				"翻阅了酷站和怪兽模板的上百种网站设计方案后，最终使用了没有设计的设计……",
		...
		},
		{
			...
			title: "PHP + CSS + MySQL",
			description:
				"参考了iPad Pro 2019官网的横向页面设计，第一版个人网站横空出世！",
				...
				<Timeline key={item.time} time={item.time}>
					...
					<div className="flex flex-wrap gap-3 mt-3">
						{item.images.map((image, i) => (
							<Image key={i} src={image} className="h-48 shadow rounded-xl" />
						))}
					</div>
				</Timeline>
			))}
