          ...
          {works.map((work, i) => (
            <a key={i} href={work.href} target="_blank">
              <Figure className="aspect-3/2 w-64">
                <Figure.Image src={work.image} alt={work.title} className="no-zoom" />
                <Figcaption>
                  <Figcaption.Title>{work.title}</Figcaption.Title>
                  <Figcaption.Description>{work.description}</Figcaption.Description>
                </Figcaption>
              </Figure>
            </a>
          ))}
